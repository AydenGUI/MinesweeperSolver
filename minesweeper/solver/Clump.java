...
import minesweeper.solver.SquareStat;
import minesweeper.solver.Cord;
...
public class Clump {
   ...
   /*
    * Combines two clumps into new clump
    */
   public Clump(Clump clump1, Clump clump2) {
      ...
      if (clump1.getClumpMines() == 0 || clump2.getClumpMines() == 0) {
         ...
         this.clumpMines = clump1.getClumpMines() + clump2.getClumpMines();
   ...
   // this.cords = overlap;
   // this.clumpMines = clump1.getClumpMines() + clump2.getClumpMines() -
   // (clump1.getCords().size() - overlap.size());
   // this.clumpMines = clumpMines < 0 ? 0 : clumpMines;
   // }

   /*
    * Checks and returns the list of overlapping coordinates between clumps.
    */
